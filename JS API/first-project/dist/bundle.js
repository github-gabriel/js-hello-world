...
function getImage() {
  var random = Math.floor(Math.random() * 1084);
  var imageURL = "https://picsum.photos/id/".concat(random, "/1920/1080");
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(imageURL)["catch"](function (error) {
    getImage();
  });
  image.src = imageURL;
}
function getText() {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("https://api.quotable.io/random").then(function (response) {
