...
var getDataBtn = document.getElementById("get");
var sendDataBtn = document.getElementById("send");
var getData = function getData() {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("https://reqres.in/api/user/1").then(function (response) {
    return console.log(response);
  });
};
var sendData = function sendData() {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("https://reqres.in/api/register", {
